...
addProduct1(formData: FormData): Observable<any> {
  return this.http.post<any>('http://localhost:42000/addproduct', formData);
}
getProducts1(): Observable<productss[]> {
  return this.http.get<productss[]>('http://localhost:42000/addproducts');
}
